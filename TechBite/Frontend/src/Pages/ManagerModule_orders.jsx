  ...
  const handlePrint = useReactToPrint({
    ...
    onAfterPrint: async () => {
      try {
        ...
        console.error(
          "Error truncating table or adding payment record:",
          error
        );
      }
    },
    ...
    <div className="manager-container">
      ...
      <div ref={componentRef} className="print-content">
        <h1 className="restaurant-name">
          The Mango Courtyard Banquet And Restaurant
        </h1>
        <div className="contact-info">
          <p>Contact No: +91 7801859797</p>
          <p>
            Address: Piplag Chokdi, Nadiad - Petlad Rd, Nadiad, Gujarat 387335
          </p>
        </div>
        ...
        <h2>
          {" "}
          <strong>
            From our kitchen to your table, thank you for choosing Us!{" "}
          </strong>
        </h2>
      </div>
...
export default ManagerModule_orders;
